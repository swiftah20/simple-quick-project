<div class="modal-container mt-3 mb-2">
    <form class="form-inline">
        <input class="form-control modal-search input-search" type="search" placeholder="Search" aria-label="Search">
    </form>
</div>
<div class="modal-container mt-3">
    <div class="row">
        <div class="col-sm-1 col-avatar">
            <div class="avatar">
        ...
        <div class="col-sm-4">
            <div class="chat-title"> 109220-Naturalization </div>
            <div class="chat-sender"> Chameron Philips :</div>
            <div class="chat-content"> Please check this out! </div>
        </div>
        <div class="col-sm-3">
            <div class="chat-date">
                02/06/2021 10:45
    ...
    <div class="row">
        ...
        <div class="col-sm-7">
            <div class="chat-title"> Jeannette Moraima Guaman Chamba (Hutto I-589) [ Hutto Follow Up - Brief
                Service ] </div>
            <div class="chat-sender"> Ellen :</div>
            <div class="chat-content"> Hey please read </div>
        </div>
        <div class="col-sm-3">
            <div class="chat-date">
                02/06/2021 10:45
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="chat-title"> 8405-Diana SALAZAR MUNGUIA </div>
            <div class="chat-sender"> Cameron Phillips :</div>
            <div class="chat-content"> I understand your initial concerns and thats very valid, Elizabeth. But you
                ... </div>
        </div>
        <div class="col-sm-3">
            <div class="chat-date">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="chat-title"> FastVisa Support </div>
            <div class="chat-content"> Hey there! Welcome to your inbox </div>
        </div>
        <div class="col-sm-3">
            <div class="chat-date">
                02/06/2021 10:45
