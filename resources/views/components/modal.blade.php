<div class="modal fade" id="modalBox" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-inbox" role="document">
        <div class="modal-content modal-content-inbox h-100">
            <div class="modal-container mt-3 mb-2">
                <form class="form-inline">
                    <input class="form-control modal-search input-search" type="search" placeholder="Search"
                        aria-label="Search">
                </form>
            </div>
            <div class="modal-container mt-3">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        {{-- <span> January 1,2021 19:10</span> --}}
